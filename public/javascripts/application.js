...
$(".sem_filtroE").click(function ()
  ...
  $(".filtro_periodoE").click(function ()
   {
     $(".consultaP").show();
     $(".consultaN").hide();
     $(".consultaT").hide();
  ...
  $(".filtro_unidadeE").click(function ()
   {
     $(".consultaU").show();
     $(".consultaN").hide();
     $(".consultaP").hide();
  ...
  $(".filtro_unidadeEU").click(function ()
   {
     $(".consulta_unidadeEU").show();
     $(".consulta_tipoEU").hide();
     $(".consulta_periodoEU").hide();
     $(".consulta_todos").hide();
   });

  $(".filtro_tipoEU").click(function ()
   {
     $(".consulta_tipoEU").show();
     $(".consulta_unidadeEU").hide();
     $(".consulta_periodoEU").hide();
     $(".consulta_todos").hide();

   });

  $(".filtro_periodoEU").click(function ()
   {
     $(".consulta_periodoEU").show();
     $(".consulta_unidadeEU").hide();
     $(".consulta_tipoEU").hide();
     $(".consulta_todos").hide();
 ...
 $(".filtro_unidade_status").click(function ()
   ...
   $(".filtro_categoria").click(function ()
   {
     ...
     $(".consulta_periodo_eventual").hide();
      ...
      $(".filtro_periodo_eventual").click(function ()
   {
     $(".consulta_periodo_eventual").show();
     $(".consulta_categoria").hide();
     $(".consulta").hide();
     $(".consulta1").hide();
     $(".consulta_unidade").hide();
