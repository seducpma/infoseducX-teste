...
#        @orc_pedido_compra[0].save
        ...
        @orc_pedido_descricao.total_geral
        @orc_pedido_compra.valor_total = @orc_pedido_descricao.total_geral
         @orc_pedido_compra.save
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(orc_pedido_compras_url) }
      format.xml  { head :ok }
    end
  end
  ...
  def create_orc_pedido_descricao
      ...
      @orc_pedido_descricao.orc_pedido_compra_id = session[:id_compra_new]
      if @orc_pedido_descricao.save
        @orc_pedido_descricaos=OrcPedidoDescricao.find(:all, :conditions =>['orc_pedido_compra_id =?', session[:id_compra_new] ])
