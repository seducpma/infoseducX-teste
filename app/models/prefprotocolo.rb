...
RETIRADA SEPARAÇÃO_DOCUMENTO SOLICITAÇÃO)
  ...
  DESTINO = %w(COMPRAS CONTABILIDADE DIRETORIA_ADMINISTRATIVA EDUCAÇÃO_INFANTIL ENSINO_FUNDAMENTAL FILANTRÓPICAS_&_CONVENIADAS FORMAÇÃO GABINETE
INFORMÁTICA MANUTENÇÃO MERENDA PLANO_CARREIRA PLANEJAMENTO PROTOCOLO_INTERNO RECURSOS_HUMANOS)
